...
//$URL = 'http://localhost/dote-energia/';
define('URL','http://localhost/encomenda-especial/novo/');
//define('URL','http://www.inova.br.com/');
...
class Cms {
	...
	public static function conteudoCategoria($cod, $cat = NULL, $slug = NULL){
	...
	public static function arquivos(){
