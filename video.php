        ...
        <div class="rev_slider" id="slider3" data-version="5.0">
          <ul>
            ...
            <li data-fstransition="fade"
              ...
              >
              <!-- MAIN IMAGE -->
              <img src="<?php echo URL;?>img/revolution/vimeobg.jpg"
                alt=""
              ...
              <!-- LAYER NR. 1 -->
              <div class="tp-caption hero-text giant_nocaps rs-parallaxlevel-3"
                data-x="center"
                data-y="center"
                data-fontsize="[116,116,100,60]"
                ...
                data-start="1000"
                style="z-index: 6;">Exuberante

              </div>
              
              <!-- LAYER NR. 2 -->
              <div class="tp-caption subheading_text rs-parallaxlevel-3"
                data-x="center"
                data-y="center"
                data-voffset="84"
                ...
                data-start="1200"
                style="z-index: 7;">A nova coleção Encomenda Especial
              </div>
              ...
              <div class="tp-caption tp-resizeme rs-parallaxlevel-3"
                ...
                data-transform_out="opacity:0;s:1000;e:Power3.easeInOut;"
                data-start="1400"
                style="min-width: 140px; z-index:6;"><a href="http://vimeo.com/82642494" class="btn btn-md btn-white lightbox-video mfp-iframe">Assista ao vídeo</a>
              </div>
